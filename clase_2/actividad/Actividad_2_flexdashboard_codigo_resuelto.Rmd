...
output: 
  flexdashboard::flex_dashboard:
    theme: cerulean
    navbar:
      - { title: "Mesa de Ayuda Salud (Informática)", href: "http://mesadeayudasalud.msgc.gcba/", align: right, icon: ion-chatbox-working}
---     
...
### Cantidad de personas empadronadas por comuna
```{r tabla}
tabla_menos_fea
```
...
### Pacientes registrados con domicilio en CABA 
```{r}
valueBox(paste0(por_pac_CABA,'%'), 
         icon = ifelse(por_pac_CABA < 85,"fa-pencil","fa-map-marker-alt"),
         color = ifelse(por_pac_CABA < 85, "danger", "primary"),
         href = 'https://www.youtube.com/watch?v=L3_5p50gFqM')
```

Hospitales {data-navmenu="Consultas"}
===
